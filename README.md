...
- **AI Agent Evaluation** at [Mindrift](https://mindrift.ai). I author and calibrate adversarial and capability test cases for LLM-powered agents. The adversarial side is indirect prompt-injection red-teaming and the capability side uses multi-source [Model Context Protocol](https://modelcontextprotocol.io/) context corpora with pytest validators, and a CI/CD pipeline gated by an LLM-as-judge quality review.
